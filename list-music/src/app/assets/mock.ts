import { DatosMusicales } from './dataType';

const mockDatosMusicales: DatosMusicales[] = [
  {
  ...
  },
  {
    ...
    esArtista: true,
    urlImagenArtista: 'https://rockfm-cdnmed.rockfm.fm/resources/jpg/5/2/1599036321325.jpg',
    urlImagenAlbum: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/3e/ACDC_Back_in_Black_cover.svg/1200px-ACDC_Back_in_Black_cover.svg.png',
    ranking: 10,
  },
  {
